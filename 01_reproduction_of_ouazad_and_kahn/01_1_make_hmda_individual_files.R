...
for (year in 1990:2003) {
  ...
  write_csv(hmda, paste0(outputfolder,'hmda_individual_', year, '.csv'))
...
hmdaspec <- read_csv("hmda/2017_Dynamic_LAR_Spec.csv",
                     skip = 1)

hmda <- read_delim("hmda/2017_lar.txt"),
...
write_csv(hmda, paste0(outputfolder,'hmda_individual_2017.csv'))
