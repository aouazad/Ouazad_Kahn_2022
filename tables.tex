...
\begin{center}
\input{01_reproduction_of_ouazad_and_kahn/tables/impact_conforming_market.tex}
\end{center}
...
\input{01_reproduction_of_ouazad_and_kahn/tables/impact_conforming_market_narrower.tex}
...
\begin{center}
\input{02_evidence_of_data_errors_in_LPW_2024_Table_7/tables/comparison_of_high_cost_dummy_values.tex}
\end{center}
...
\begin{center}
\input{02_evidence_of_data_errors_in_LPW_2024_Table_7/tables/nans_in_high_cost_dummy_by_action_taken.tex}
\end{center}
...
\begin{center}
\input{02_evidence_of_data_errors_in_LPW_2024_Table_7/tables/nans_in_high_cost_dummy_by_state.tex}
\end{center}
...
\begin{center}
    \input{02_evidence_of_data_errors_in_LPW_2024_Table_7/tables/excluded_ZIPs_in_treatment_group.tex}
\end{center}
...
\begin{center}
    \input{02_evidence_of_data_errors_in_LPW_2024_Table_7/tables/summary_diff_log_loan_amount_excluded_ZIPs.tex}
\end{center}
...
\begin{center}
\input{03_flaws_in_the_independent_replication_table_8/tables/non_mutually_exclusive_time_dummies_formatted.tex}
\end{center}
...
\begin{center}
\input{03_flaws_in_the_independent_replication_table_8/tables/incorrect_treatment_years_formatted.tex}
\end{center}
